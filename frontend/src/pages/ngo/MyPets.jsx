  ...
  return (
    <div className="min-h-screen bg-neutral-50 p-8">
      <div className="flex justify-between items-center mb-6">
        ...
        <Link
          to="/ngo/pets/new"
          className="bg-primary-500 text-white px-4 py-2 rounded-xl text-sm hover:bg-primary-600"
        >
          + Add Pet
        </Link>
      </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
        ...
        {pets.length === 0 && (
          <p className="text-neutral-500">No pets listed yet.</p>
        )}
      </div>
    </div>
  );
